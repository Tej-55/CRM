...
import auxiliary_multilabel as aux #self-created library
...
aux.create_models(X_train,y_train,neuron_grid,activation='relu',dropout_rate=0.5)
...
#y_pred[y_pred >= 0.5] = 1
#y_pred[y_pred < 0.5] = 0
np.savetxt('mlp_pred.csv', y_pred, fmt='%1.4f')
